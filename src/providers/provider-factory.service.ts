...
export class ProviderFactoryService {
  ...
  constructor(private readonly circuitBreakerService: CircuitBreakerService) {
    ...
    this.providers.set('PushProvider1', new PushProviderService1(this.circuitBreakerService));
    this.providers.set('PushProvider2', new PushProviderService2(this.circuitBreakerService));
    this.providers.set('EmailProvider1', new EmailProviderService1(this.circuitBreakerService));
    this.providers.set('EmailProvider2', new EmailProviderService2(this.circuitBreakerService));
  }
